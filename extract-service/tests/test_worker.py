...
def test_preis_kommt_aus_dem_impressum(monkeypatch):
    """Die Titelseite wird nicht gelesen; das Impressum ist die einzige Quelle
    im Heft. Den Verkaufspreis holt spaeter der Abgleich mit dem Netzladen."""
    gesendet: list[dict] = []
    ...
    _Job()._store_meta(
        [{"kind": "pdf", "role": "inner", "assetId": "a1"}], {"a1": b"x"}
    )
